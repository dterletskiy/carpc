...
bool test( int argc, char* argv[ ] )
{
   ...
   base::os::Socket::tSptr mp_socket_master = std::shared_ptr< base::os::Socket >( new base::os::Socket( confguration_core, 4096 ) );
   ...
   base::os::Socket::tSptr mp_client_socket = std::shared_ptr< base::os::Socket >( new base::os::Socket( confguration_controller, 4096 ) );
