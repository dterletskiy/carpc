...
// Application
#include "OnOff_v.2.0.0.hpp"

#include "api/sys/trace/Trace.hpp"
#define CLASS_ABBR "OnOff_Client_OnOff_2.0.0"



using namespace application::components::onoff::client::V2_0_0;
...
void OnOff::request_trigger_state( const std::string& state, const size_t delay )
{
   ...
   service::onoff::V2_0_0::Client::request_trigger_state( state, delay );
}
