...
namespace base {
   ...
   class TBaseEvent_ID
   {
      template< typename TYPE >
         friend ByteBuffer& operator << ( ByteBuffer& buffer, const TBaseEvent_ID< TYPE >& event_id );
      template< typename TYPE >
         friend ByteBuffer& operator >> ( ByteBuffer& buffer, TBaseEvent_ID< TYPE >& event_id );

   public:
      bool to_buffer( ByteBuffer& buffer ) { return buffer.push_back( m_id ); }
      bool from_buffer( ByteBuffer& buffer ) { return buffer.pop_back( m_id ); }
   ...
   public:
      ...
      const char* c_str( ) const
      {
         ...
         {
            static std::string name = base::to_string( m_id );
            return name.c_str( );
         }
   ...
   template< typename TYPE >
   ByteBuffer& operator << ( ByteBuffer& buffer, const TBaseEvent_ID< TYPE >& event_id )
   {
      buffer << event_id.m_id;
      return buffer;
   }
   template< typename TYPE >
   ByteBuffer& operator >> ( ByteBuffer& buffer, TBaseEvent_ID< TYPE >& event_id )
   {
      buffer >> event_id.m_id;
      return buffer;
   }
...
namespace base {
   ...
   using Event_ID = TEvent_ID< tID, true >;
