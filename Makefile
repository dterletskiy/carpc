...
$(TARGET_BUILD): $(PROJECT_HOOKS_NAME)_$(TARGET_BUILD) $(PROJECT_FRAMEWORK_NAME)_$(TARGET_BUILD) $(PROJECT_APPLICATION_NAME)_$(TARGET_BUILD) $(PROJECT_SERVICEBROCKER_NAME)_$(TARGET_BUILD)

$(TARGET_GENERATE): $(PROJECT_HOOKS_NAME)_$(TARGET_GENERATE) $(PROJECT_FRAMEWORK_NAME)_$(TARGET_GENERATE) $(PROJECT_APPLICATION_NAME)_$(TARGET_GENERATE) $(PROJECT_SERVICEBROCKER_NAME)_$(TARGET_GENERATE)

$(TARGET_CLEAN): $(PROJECT_HOOKS_NAME)_$(TARGET_CLEAN) $(PROJECT_FRAMEWORK_NAME)_$(TARGET_CLEAN) $(PROJECT_APPLICATION_NAME)_$(TARGET_CLEAN) $(PROJECT_SERVICEBROCKER_NAME)_$(TARGET_CLEAN)

$(TARGET_INFO): $(PROJECT_HOOKS_NAME)_$(TARGET_INFO) $(PROJECT_FRAMEWORK_NAME)_$(TARGET_INFO) $(PROJECT_APPLICATION_NAME)_$(TARGET_INFO) $(PROJECT_SERVICEBROCKER_NAME)_$(TARGET_INFO)
