...
APP1_MAKE_PARAMS   := PROJECT_NAME=$(PROJECT_APP1_NAME) PROJECT_DIR=$(PROJECT_APP1_DIR) PRODUCT_DIR=$(PRODUCT_APP1_DIR)

$(PROJECT_APP1_NAME)_$(TARGET_BUILD):
	$(MAKE) -C $(PROJECT_APP1_DIR) $(TARGET_BUILD) $(APP1_MAKE_PARAMS)

$(PROJECT_APP1_NAME)_$(TARGET_GENERATE):
	$(MAKE) -C $(PROJECT_APP1_DIR) $(TARGET_GENERATE) $(APP1_MAKE_PARAMS)

$(PROJECT_APP1_NAME)_$(TARGET_CLEAN):
	$(MAKE) -C $(PROJECT_APP1_DIR) $(TARGET_CLEAN) $(APP1_MAKE_PARAMS)

$(PROJECT_APP1_NAME)_$(TARGET_INFO):
	$(MAKE) -C $(PROJECT_APP1_DIR) $(TARGET_INFO) $(APP1_MAKE_PARAMS)

$(PROJECT_APP1_NAME)_$(TARGET_ARCHIVE):
	$(MAKE) -C $(PROJECT_APP1_DIR) $(TARGET_ARCHIVE) $(APP1_MAKE_PARAMS)

$(PROJECT_APP1_NAME)_$(TARGET_EXECUTE):
	$(MAKE) -C $(PROJECT_APP1_DIR) $(TARGET_EXECUTE) $(APP1_MAKE_PARAMS)



APP2_MAKE_PARAMS   := PROJECT_NAME=$(PROJECT_APP2_NAME) PROJECT_DIR=$(PROJECT_APP2_DIR) PRODUCT_DIR=$(PRODUCT_APP2_DIR)

$(PROJECT_APP2_NAME)_$(TARGET_BUILD):
	$(MAKE) -C $(PROJECT_APP2_DIR) $(TARGET_BUILD) $(APP2_MAKE_PARAMS)

$(PROJECT_APP2_NAME)_$(TARGET_GENERATE):
	$(MAKE) -C $(PROJECT_APP2_DIR) $(TARGET_GENERATE) $(APP2_MAKE_PARAMS)

$(PROJECT_APP2_NAME)_$(TARGET_CLEAN):
	$(MAKE) -C $(PROJECT_APP2_DIR) $(TARGET_CLEAN) $(APP2_MAKE_PARAMS)

$(PROJECT_APP2_NAME)_$(TARGET_INFO):
	$(MAKE) -C $(PROJECT_APP2_DIR) $(TARGET_INFO) $(APP2_MAKE_PARAMS)

$(PROJECT_APP2_NAME)_$(TARGET_ARCHIVE):
	$(MAKE) -C $(PROJECT_APP2_DIR) $(TARGET_ARCHIVE) $(APP2_MAKE_PARAMS)

$(PROJECT_APP2_NAME)_$(TARGET_EXECUTE):
	$(MAKE) -C $(PROJECT_APP2_DIR) $(TARGET_EXECUTE) $(APP2_MAKE_PARAMS)
